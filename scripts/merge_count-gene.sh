...
merged_file_count="${folder_path}/RxHN_genes_count_results.tsv" # you can change result name this line
touch "$merged_file_count"
merged_file_FPRK="${folder_path}/RxHN_genes_FPRK_results.tsv"  # you can change result name this line
touch "$merged_file_FPRK"
merged_file_TPM="${folder_path}/RxHN_genes_TPM_results.tsv"    # you can change result name this line
touch "$merged_file_TPM"

# Get all files that end with '.isoforms.results'
files=$(find "$folder_path" -name '*.genes.results'| sort )
